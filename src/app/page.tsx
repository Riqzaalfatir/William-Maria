...
// TEMP: matiin loading screen & opening buat testing scroll
const DEBUG_SKIP_INTRO = true;

export default function Home() {
  const [start, setStart] = useState<boolean>(DEBUG_SKIP_INTRO ? true : false);
  const [showLoading, setShowLoading] = useState<boolean>(DEBUG_SKIP_INTRO ? false : true);
  ...
  return (
    <>
      ...
      {!DEBUG_SKIP_INTRO && !start && <Opening setStart={setStart} namaTamu="Sela" />}

      {!DEBUG_SKIP_INTRO && showLoading && (
        <LoadingScreen
          progress={progress}
