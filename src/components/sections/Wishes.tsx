        ...
        <div className="w-full max-w-[284px] lg:max-w-[583px] mx-auto mt-[38px] lg:mt-[65px]">
          <div className="flex flex-col gap-[20px]">
            ...
            <button
              ...
              className="bg-[#535353] w-full rounded-[5px] h-[33px] lg:h-[40px] text-[12px] lg:text-[18px] font-athelas uppercase flex items-center justify-center gap-0.5 lg:gap-1 text-[#FFFFFF] tracking-widest"
            >
              <Image
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/0 to-transparent opacity-0 group-hover:opacity-10 transition-opacity pointer-events-none" />
            ...
            <button
              ...
              className="bg-[#535353] w-full rounded-[5px] h-[33px] lg:h-[40px] text-[12px] lg:text-[18px] font-athelas uppercase flex items-center justify-center gap-1.5 text-white tracking-widest"
            >
              <Image
