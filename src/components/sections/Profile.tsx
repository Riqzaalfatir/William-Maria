  ...
  return (
    <section id="profile">
      <div className="relative w-full bg-[#F4F4F5]">
        ...
        />
        <div className="relative pt-[25.90vw] pb-[25.90vw] flex flex-col items-center justify-center leading-none">
          <div className="flex flex-col items-center text-center justify-center leading-none">
            <h3 className="font-athelas text-[3.08vw] text-[#717071] leading-[3.46vw]">
              MR. TOMI TANUDJAJA (†)
              <br />
              MRS. KO KOEY FAH
            </h3>
            <p className="pt-[4.62vw] font-athelas italic text-[3.08vw] text-[#717071]">
              together with
            </p>
            <h3 className="pt-[4.3vw] font-athelas text-[3.08vw] text-[#717071] leading-[3.59vw]">
              MR. EDIH SUTISNA
              <br />
              MRS. INA MARINA
            </h3>
          </div>
          <p className="pt-[5.5vw] font-athelas italic text-[3.08vw] text-[#717071]">
            Cordially invite you to celebrate the wedding reception of
          </p>
          <div className="pt-[2vw] flex flex-col items-center text-center justify-center leading-none">
            <Image
              src="/images/profile/William.webp"
              alt="William"
              width={247}
              height={92}
              className="h-auto w-[63.33vw]"
            />
            <h3 className="-mt-[2.82vw] font-averne text-[4.62vw] text-[#50473F]">
              CHRISTIAN TANUDJAJA
            </h3>
            <Image
              ...
              width={247}
              height={92}
              className="-mt-[0.5vw] h-auto w-[63.33vw]"
            />
            <h3 className="-mt-[5.5vw] font-averne text-[4.62vw] text-[#50473F]">
              LAWRENA
            </h3>
          </div>
          <div className="pt-[7.5vw] flex flex-col items-center text-center justify-center leading-none">
            <p className="font-athelas text-[3.08vw] text-[#717071]">
              SATURDAY, <span className="font-urw">19</span> SEPTEMBER 2026
            </p>
            <p className="pt-[4.5vw] font-athelas text-[3.08vw] text-[#717071] leading-[4.10vw]">
              INTERCONTINENTAL HOTEL BANDUNG <br />
              <span className="italic">
                Jl. Resor Dago Pakar Raya 2B, Bandung
              </span>
            </p>
            <p className="pt-[7.69vw] font-athelas italic text-[3.08vw] text-[#717071] leading-[3.85vw]">
