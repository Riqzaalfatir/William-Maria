  ...
  return (
    <section>
      <div className="relative w-full">
        ...
        <div className="relative pt-[10.51vw] pb-[13.85vw] lg:pt-[43px] lg:pb-[108px] flex flex-col items-center text-center justify-center leading-none gap-[9.49vw] lg:gap-[10px]">
          <p className="font-averne text-[3.08vw] text-white lg:hidden">
