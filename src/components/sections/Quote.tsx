...
//   // Cuma ukur LEBAR viewport (buat drag constraint & posisi translateX).
//   // Tinggi TIDAK diukur pakai JS sama sekali -> gak ada race condition sama loading gambar -> gak ada reflow -> gak loncat.
...
//   // Posisikan track tiap kali index atau lebar berubah, kecuali lagi di-drag manual
//   useEffect(() => {
...
//     let nextIndex = index;
//     if (info.offset.x < -swipeThreshold) nextIndex = (index + 1) % total;
//     else if (info.offset.x > swipeThreshold) nextIndex = (index - 1 + total) % total;

//     setIndex(nextIndex);
//     controls.start({
//       x: -nextIndex * trackWidth,
...
//                 <div
//                   key={i}
//                   className="flex flex-col items-center justify-center shrink-0 h-full overflow-hidden"
