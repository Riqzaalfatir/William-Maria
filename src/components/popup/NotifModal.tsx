    ...
    >
      <div className="relative bg-white rounded-lg lg:rounded-2xl shadow-xl flex flex-col items-center text-center animate-modalIn overflow-hidden w-[322px] h-[360px] lg:w-[485px] lg:h-[543px]">
        <div className="flex-1 flex flex-col items-center justify-start pt-[37px] lg:pt-[57px] px-7 lg:px-10 w-full">
          ...
          <h3 className="uppercase tracking-[0.12em] mb-4 lg:mb-6 text-[16px] lg:text-[24px] font-extrabold text-[#605F5E] font-sans">
            {config.title}
          </h3>

          <p className="text-[12px] lg:text-[18px] text-[#605F5E] font-medium mb-3 lg:mb-6 font-sans">
            {config.messageid}
          </p>

          <p className="text-[12px] lg:text-[18px] text-[#605F5E] font-medium mb-2 lg:mb-4 font-sans">
            {config.messageen}
          </p>
        </div>
